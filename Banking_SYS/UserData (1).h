...
public:
    ...
    static User *getUser(string username)
    {
        ...
        string value, password, firstName, lastName, secretKey;
        double balance;
    ...
    static User *getUserByAccNo(unsigned int accountNo)
    {
        ...
        if (file.is_open())
        {
            ...
            while (!file.eof())
            {
                ...
                if (accountNo == stoi(found_account))
                {
    ...
    static string getHistory(unsigned int account_no)
    {
        ...
        if (file.is_open())
        {
            ...
            while (!file.eof())
            {
                ...
                time_t timestamp_t = static_cast<time_t>(stol(timestamp));
